    ...
    <div className="relative flex h-[6vh] p-2 items-center justify-between">
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div className="flex flex-shrink-0 items-center">
          <img className="h-8 w-auto rounded-lg" src="../../public/logo.png" alt="Your Company"/>
        </div>
        <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">

            <a href="#" className="bg-gray-900 h-[4.5vh] my-1 flex items-center text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Dashboard</a>
      ...
      <IoSettings style = {{fontSize:"1.4em"}} className='m-[auto] h-[4.5vh] w-[2em] hover:bg-gray-700 rounded-md' />
